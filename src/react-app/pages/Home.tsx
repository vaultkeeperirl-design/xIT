...
export default function Home() {
  ...
  // Compute the active tab and active clips based on which tab is selected
  // ⚡ Bolt: Memoize activeTab to prevent O(N) array lookups on every render frame
  // and simplify derived dependencies
  const activeTab = useMemo(() => {
    if (activeTabId === 'main') return undefined;
