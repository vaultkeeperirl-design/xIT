...
export default function Home() {
  ...
  // ⚡ Bolt: Cache activeTab lookup to prevent O(N) re-evaluation on every render and interaction


  const activeTab = useMemo(() => timelineTabs.find(tab => tab.id === activeTabId), [timelineTabs, activeTabId]);
